...
const groups: {  links: LinkItem[] }[] = [
  {
    links: [
       { label: "About", href: "https://www.ridgebackbuilt.com/about" },
  { label: "Blogs", href: "https://www.ridgebackbuilt.com/blogs" },
  { label: "Services", href: "https://www.ridgebackbuilt.com/services" },
  { label: "Projects", href: "https://www.ridgebackbuilt.com/projects" },
      { label: "Contact Us", href: "contact.ridgebackbuilt.com" },
    ],
  },
];
...
export default function Footer() {
            ...
            <div className="mt-4 flex items-center justify-center gap-3">
              ...
              >
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M12 2c0 1.1.3 2.1.8 3 .5.8 1.2 1.5 2 2 .9.5 1.9.8 3 .8V5.3c-.8 0-1.5-.2-2.2-.5-.7-.4-1.3-.9-1.8-1.6-.5-.6-.8-1.3-.9-2.1H12zm0 5.3v8.4c0 1.1-.4 2.1-1.1 2.8-.8.8-1.8 1.2-2.9 1.2s-2.1-.4-2.9-1.2A4 4 0 0 1 4 15.7c0-2.3 1.8-4.2 4-4.2.5 0 1 .1 1.5.3V9.4c-.5-.1-1-.1-1.5-.1a7 7 0 0 0-4.9 2A6.8 6.8 0 0 0 2 15.7a6.9 6.9 0 0 0 2.1 5c1.4 1.3 3.2 2 5 2a6.8 6.8 0 0 0 5-2c1.3-1.4 2-3.2 2-5.1V9.3c-.8-.1-1.5-.4-2.2-.8-.6-.4-1.2-.8-1.7-1.3z" />
                </svg>
  ...
  License No. <span className="font-semibold">CGC1538364</span>
</p>
...
/* ---------- Pieces ---------- */
function LinksColumn({ g }: { g: { links: LinkItem[] } }) {
  return (
    <section className="max-w-sm" data-animate>
      <nav>
